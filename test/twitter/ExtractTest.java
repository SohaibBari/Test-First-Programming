...
public class ExtractTest {
    ...
    private static final Tweet tweet3 = new Tweet(3, "boi", "rivest talk in @maheer 30 minutes #hype", d3);
    private static final Tweet tweet4 = new Tweet(3, "boi", "rivest talk in @rosheen @maheer 30 minutes #hype", d4);
    ...
    public void testGetMentionedUsersOneMention() {
        ...
        for (String user: mentionedUsers) {
        	assertTrue("expected @maheer", user.equals("@maheer"));
        }
    ...
    public void testGetMentionedUsersTwoMention() {
        ...
        for (String user: mentionedUsers) {
        	assertTrue("expected @maheer or @rosheen", user.equals("@maheer") || user.equals("@rosheen"));
        }
